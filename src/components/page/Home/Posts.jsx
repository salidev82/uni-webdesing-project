    ...
    return (
        <div>
            <div className='text-center mt-10'>
                ...
                <h2 className='text-black text-2xl'>آخرین اخبار معماری و طراحی در بخش بلاگ ما</h2>
                <div className='grid lg:grid-cols-3 grid-cols-1 gap-8 my-8'>
                    {
                        fakeData.map((item) => {
                            return <PostCard key={item.id} img={item.img} title={item.title} description={item.description} />
                        })
                    }
                </div>
            </div>
